...
Plug 'svermeulen/vim-macrobatics' " TODO maybe check if im actually using this as I should...
...
nnoremap <C-f> :CocList -I grep -F <CR>
...
let g:python3_host_prog = '/Users/jonatanbranting/.pyenv/versions/neovim3/bin/python'
nmap <silent> gr <Plug>(coc-references)
